...
class GanttChartAnggota extends Controller
{
  ...
  public function get($id_project, $id_anggota)
  {
        return view('anggota.ganttchart', [ 'id_project' => $id_project, 'id_anggota' => $id_anggota ]);
        // return view('anggota.ganttchart');
  }
  public function getvalueganttchart($id_project, $id_anggota)
  {
